        ...
        <div class="container mx-auto flex items-center justify-between py-4 px-16">
            ...
            <nav class="hidden md:flex items-center gap-x-6">
                ...
                <div class="relative" x-data="{ open: false }">
                    ...
                    <!-- Dropdown items with @click.away directive -->
...
<body class="font-sans antialiased bg-gray-50">
    <!-- About Us Section -->
    <section id="about-us-detail" class="relative bg-cover bg-center h-auto py-16 text-black">
        <div class="container mx-auto px-6">
            <!-- Logo and Company Name -->
            <div class="flex items-center justify-center mb-8">
                <img src="{{ asset('images/aboutus/' . $aboutUsDetail->image) }}" alt="Company Logo" class="h-24 mr-4">
                <span class="text-2xl font-semibold text-gray-700">{{ $aboutUsDetail->company_name }}</span>
            </div>
